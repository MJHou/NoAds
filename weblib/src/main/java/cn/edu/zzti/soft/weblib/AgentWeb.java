...
public class AgentWeb {
    ...
    private AgentWeb(AgentBuilder agentBuilder) {
        ...
        this.mOnLongClickListener = agentBuilder.mOnLongClickListener;
    ...
    private AgentWeb(AgentBuilderFragment agentBuilderFragment) {
        ...
        this.mOnLongClickListener = agentBuilderFragment.mOnLongClickListener;
...
//                throw new IllegalStateException(" please call ready before go  to finish all webview settings");  //i want to do this , but i cannot;
    ...
    public static class CommonAgentBuilder {
        ...
        public CommonAgentBuilder setOnLongClickListener(@Nullable View.OnLongClickListener longClickListener) {
            this.mAgentBuilder.mOnLongClickListener = longClickListener;
            return this;
        }
