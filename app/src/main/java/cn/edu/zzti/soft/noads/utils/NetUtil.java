    ...
    public static int getNetworkGeneration(int networkType) {
        switch (networkType) {
            ...
            case TelephonyManager.NETWORK_TYPE_IDEN:
                return Constant.Network.NETWORK_2_G;
            ...
            case TelephonyManager.NETWORK_TYPE_HSPAP:
                return Constant.Network.NETWORK_3_G;
            case TelephonyManager.NETWORK_TYPE_LTE:
                return Constant.Network.NETWORK_4_G;
            default:
                return Constant.Network.NETWORK_UNKNOWN;
        }
    }

    public static final String getNetworkTypeName(int type) {
        switch (type) {
            case TelephonyManager.NETWORK_TYPE_GPRS:
                return "GPRS";
            case TelephonyManager.NETWORK_TYPE_EDGE:
